...
#ifndef MPGSDK_SWIFT_H
#define MPGSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MPGSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///
/// \endcode
SWIFT_CLASS("_TtC6MPGSDK7Gateway")
...
@interface Gateway (SWIFT_EXTENSION(MPGSDK)) <NSURLSessionDelegate>
...
SWIFT_CLASS("_TtC6MPGSDK29Gateway3DSecureViewController")
