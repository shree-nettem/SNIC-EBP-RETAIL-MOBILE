...
import 'package:ebpv2/src/views/ui/auth/login/login_controller.dart';
...
import 'identity_verification_required_controller.dart';

class IdentityVerificationRequiredScreen extends StatelessWidget {
  final IdentityVerificationRequiredXController controller =
      Get.put(IdentityVerificationRequiredXController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: <Widget>[
          CustomSilverBar(
              title: 'identity_verification'.tr, isBackButtonExist: false),
          SliverFillRemaining(
            hasScrollBody: false,
            child: GetBuilder(
              init: controller,
            ...
            Column(
              children: [
                GestureDetector(
                    ...
                    child: IdentityButtonView()),
                SizedBox(height: 12),
                GestureDetector(
                    onTap: () {
                      controller.initializeJumio();
                    },
                    child: FacialButtonView()),
                SizedBox(height: 32),
                CustomButton(
                  title: 'next'.tr,
                  width: 114,
