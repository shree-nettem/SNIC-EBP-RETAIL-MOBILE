...
import 'package:ebpv2/src/views/ui/customer_profile/change_email/change_email_controller..dart';
...
class ChangeEmailScreen extends StatelessWidget {
  final ChangeEmailXController controller = Get.put(ChangeEmailXController());
...
class ConfirmEmailView extends StatelessWidget {
  final ChangeEmailXController controller;
        ...
        child: Column(
          ...
          children: [
            ...
            CustomTextField(
              ...
              onChanged: (value) {
                vController.updateRequester(value);
