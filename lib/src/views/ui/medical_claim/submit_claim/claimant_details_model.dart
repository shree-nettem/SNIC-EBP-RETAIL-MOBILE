...
List<ClaimantDetails> claimantDetailsFromJson(String str) =>
    List<ClaimantDetails>.from(
        json.decode(str).map((x) => ClaimantDetails.fromJson(x)));

String claimantDetailsToJson(List<ClaimantDetails> data) =>
...
class ClaimantDetails {
  ...
  factory ClaimantDetails.fromJson(Map<String, dynamic> json) =>
      ClaimantDetails(
