...
import 'widgets/ghady_tab_view.dart';

class GhadySavingHomeScreen extends StatelessWidget {
  final GhadySavingHomeController controller =
      Get.put(GhadySavingHomeController());
